...
class BaseTaggedDocsTest(TestCase):
    ...
    def test_get_para_hashes(self, mock_should_include):
        ...
        para = Para(
            title='title 1',
            eid=None,
            content='This is the content of title 1'
        )
        para_2 = Para(
            title='title 1',
            eid=None,
            content='This is the content of title 2'
        )
        ...
        self.assertEqual(
            ...
            {311784746898390805096967306140810741725, 223673265617601130829714390136355227675}
        )
